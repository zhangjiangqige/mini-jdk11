...
public interface ResultSet extends Wrapper, AutoCloseable {
    ...
    java.sql.@Nullable Timestamp getTimestamp(int columnIndex, Calendar cal) throws SQLException;

    java.sql.@Nullable Timestamp getTimestamp(String columnLabel, Calendar cal) throws SQLException;
